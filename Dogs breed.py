  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-6">
        ...
        {% if result %}
        <div class="card">
          <img src="{{ result.image_url }}" class="card-img-top" alt="{{ result.breed }} 照片">
...
def generate_dog_image(breed: str) -> str:
    ...
    try:
        resp = openai.Image.create(
            prompt=f"High quality photo of a {breed} dog, realistic photography", n=1, size="512x512"
        )
